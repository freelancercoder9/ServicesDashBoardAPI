...
public interface ApiDetailsRepository extends JpaRepository<ApiDetails, Long> {
    ...
    @Query(value = "select ad.id , ad.api_name ,ad.app_instance_id , ad.api_request_type ,ad.dev_status_date ,ad.dev_status ,ad.developer_name ,ad.prod_status_date ,ad.prod_status ,ad.uat_status_date ,ad.uat_status,\n" +
