...
public class AppInstanceServiceImpl implements AppInstanceService {
    ...
    public Optional<AppInstanceDetails> findByAppInstanceID(Long apiInstanceId) {
        ...
        if (byId.isEmpty()) {
            throw new ErrorDetails("API_INSTANCE_ERROR_100", "App instance not found", HttpStatus.NOT_FOUND);
        }
    ...
    public AppInstanceDetails createAppInstance(AppInstanceDetails appInstanceDetails) {
        try {
            ...
            throw new ErrorDetails("API_INSTANCE_ERROR_200", "Failed to save App instance Details", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
}
